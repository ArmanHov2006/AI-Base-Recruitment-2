...
async def _run_pipeline(
    ...
    async with session_factory() as db:
        ...
        # Load answers eagerly (relationship already selectin; this is defensive)
        ...
        # interview_session_id column does not exist on CandidateEvaluation yet;
        # skip assignment until a migration adds it.
